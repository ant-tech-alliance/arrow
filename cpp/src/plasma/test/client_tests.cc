...
class TestPlasmaStoreBase : public ::testing::Test {
 public:
  ...
  void SetUp() {
    ...
    ARROW_LOG(ERROR) << "store_socket_name_: " << store_socket_name_;
    ...
    ARROW_LOG(ERROR) << "original command: " << plasma_command;
    ...
    plasma_command = ostream.str();
    ARROW_LOG(ERROR) << "new command: " << plasma_command;

...
java -cp target/test-classes:target/classes -Djava.library.path=${TRAVIS_BUILD_DIR}/cpp-build/debug/:~/.m2/repository/org/apache/commons/commons-lang3/3.6/ org.apache.arrow.plasma.PlasmaClientTest
